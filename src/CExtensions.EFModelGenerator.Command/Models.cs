...
namespace my.business.space
{
   ...
   public partial class DossierPrepension
   {
      ...
      [ForeignKey("AemId")]
      public virtual ActiviteEmployeur ActiviteEmployeur { get; set; }

      // Reverse Navigation

      [InverseProperty("DppId")]
      public virtual List<PrimePrepension> PrimePrepension { get; set; }

      [InverseProperty("DppId")]
      public virtual List<ImmunisationJours> ImmunisationJours { get; set; }
   ...
   public partial class Fonds
   {
      ...
      [InverseProperty("FndId")]
      public virtual List<ActiviteEmployeur> ActiviteEmployeur { get; set; }

      [InverseProperty("FndId")]
      public virtual List<CategorieEmployeur> CategorieEmployeur { get; set; }
   ...
   public partial class AttA038
   {
      ...
      [ForeignKey("Snd38Id")]
      public virtual SendingA038 SendingA038 { get; set; }
      ...
      [InverseProperty("Att38Id")]
      public virtual List<AttA038Individualatt> AttA038Individualatt { get; set; }
   ...
   public partial class Pension
   {
      ...
      [InverseProperty("PenId")]
      public virtual List<PensionTravailleur> PensionTravailleur { get; set; }

      [InverseProperty("PenId")]
      public virtual List<FichePension> FichePension { get; set; }

      [InverseProperty("PenId")]
      public virtual List<PensionLettredepart> PensionLettredepart { get; set; }
   ...
   public partial class PensionContrat
   {
      ...
      [ForeignKey("DtrId")]
      public virtual PensionTravailleur PensionTravailleur { get; set; }
      ...
      [InverseProperty("DctId")]
      public virtual List<LigneTravailleur> LigneTravailleur { get; set; }

      [InverseProperty("DctId")]
      public virtual List<SolidariteInactivite> SolidariteInactivite { get; set; }
   ...
   public partial class AttA052
   {
      ...
      [ForeignKey("Snd52Id")]
      public virtual SendingA052 SendingA052 { get; set; }
      ...
      [InverseProperty("Act52Id")]
      public virtual List<AttA052Activity> AttA052Activity { get; set; }

      [InverseProperty("Att52Id")]
      public virtual List<AttA052Decisionniccin> AttA052Decisionniccin { get; set; }
   ...
   public partial class SendingA038
   {
      ...
      [InverseProperty("Snd38Id")]
      public virtual List<AttA038> AttA038 { get; set; }
   ...
   public partial class DeclarationOnss
   {
      ...
      [InverseProperty("DecId")]
      public virtual List<DeclarationTravailleur> DeclarationTravailleur { get; set; }
   ...
   public partial class SendingA045
   {
      ...
      [InverseProperty("Snd45Id")]
      public virtual List<AttA045> AttA045 { get; set; }
   ...
   public partial class SendingA052
   {
      ...
      [InverseProperty("Snd52Id")]
      public virtual List<AttA052> AttA052 { get; set; }
   ...
   public partial class PrimeContrat
   {
      ...
      [ForeignKey("PtrId")]
      public virtual PrimeTravailleur PrimeTravailleur { get; set; }
      ...
      [InverseProperty("PctId")]
      public virtual List<LigneReleve> LigneReleve { get; set; }
   ...
   public partial class PrimeTravailleur
   {
      ...
      [InverseProperty("PtrId")]
      public virtual List<PrimeContrat> PrimeContrat { get; set; }

      [InverseProperty("PtrId")]
      public virtual List<Titre> Titre { get; set; }

      [InverseProperty("PtrId")]
      public virtual List<RetenueCreance> RetenueCreance { get; set; }
   ...
   public partial class DeclarationTravailleur
   {
      ...
      [InverseProperty("DtvId")]
      public virtual List<DeclarationCotisationprepension> DeclarationCotisationprepension { get; set; }
   ...
   public partial class Titre
   {
      ...
      [ForeignKey("LotId")]
      public virtual DecompteLot DecompteLot { get; set; }

      // Reverse Navigation

      [InverseProperty("TitId")]
   ...
   public partial class PensionTravailleur
   {
      ...
      [InverseProperty("DtrId")]
      public virtual List<PensionContrat> PensionContrat { get; set; }
   ...
   public partial class ActiviteEmployeur
   {
      ...
      [InverseProperty("AemId")]
      public virtual List<DossierPrepension> DossierPrepension { get; set; }

      [InverseProperty("AemId")]
      public virtual List<Contrat> Contrat { get; set; }

      [InverseProperty("AemId")]
      public virtual List<ValidationEnvoi> ValidationEnvoi { get; set; }
   ...
   public partial class Contrat
   {
      ...
      [InverseProperty("ConId")]
      public virtual List<PensionContrat> PensionContrat { get; set; }

      [InverseProperty("ConId")]
      public virtual List<AncienneteContrat> AncienneteContrat { get; set; }
      ...
      [InverseProperty("ConId")]
      public virtual List<DossierIntervention> DossierIntervention { get; set; }
   ...
   public partial class DrsEnvoi
   {
      ...
      [InverseProperty("DrsId")]
      public virtual List<DrsA037> DrsA037 { get; set; }

      [InverseProperty("DrsId")]
      public virtual List<DrsA044Attestation> DrsA044Attestation { get; set; }
   ...
   public partial class AttA045
   {
      ...
      [ForeignKey("Snd45Id")]
      public virtual SendingA045 SendingA045 { get; set; }
      ...
      [InverseProperty("Att45Id")]
      public virtual List<AttA045Disease> AttA045Disease { get; set; }
   ...
   public partial class Livre
   {
      ...
      [InverseProperty("LivId")]
      public virtual List<DecompteLot> DecompteLot { get; set; }
   ...
   public partial class Intervention
   {
      ...
      [ForeignKey("DiaId")]
      public virtual DemandeInterventionAutomatique DemandeInterventionAutomatique { get; set; }

      // Reverse Navigation

      [InverseProperty("IntId")]
      public virtual List<Payement> Payement { get; set; }
   ...
   public partial class LigneReleve
   {
      ...
      [ForeignKey("PctId")]
      public virtual PrimeContrat PrimeContrat { get; set; }

      // Reverse Navigation

      [InverseProperty("LreId")]
      public virtual List<MouvementAssimilation> MouvementAssimilation { get; set; }

      [InverseProperty("LreId")]
      public virtual List<MouvementRemuneration> MouvementRemuneration { get; set; }
   ...
   public partial class Travailleur
   {
      ...
      [InverseProperty("TraId")]
      public virtual List<PrimeTravailleur> PrimeTravailleur { get; set; }
      ...
      [InverseProperty("TraId")]
      public virtual List<DrsA037Dossierannuel> DrsA037Dossierannuel { get; set; }
      ...
      [InverseProperty("TraId")]
      public virtual List<DrsA044Dossier> DrsA044Dossier { get; set; }
   ...
   public partial class AttA045Disease
   {
      ...
      [InverseProperty("Dis45Id")]
      public virtual List<AttA045Decisionfbzfmp> AttA045Decisionfbzfmp { get; set; }
   ...
   public partial class AttA045Decisionfbzfmp
   {
      ...
      [InverseProperty("Dcn45Id")]
      public virtual List<AttA045Decisiondetail> AttA045Decisiondetail { get; set; }
   ...
   public partial class Employeur
   {
      ...
      [InverseProperty("EmpId")]
      public virtual List<MutationOnss> MutationOnss { get; set; }

      [InverseProperty("EmpId")]
      public virtual List<ActiviteEmployeur> ActiviteEmployeur { get; set; }

      [InverseProperty("EmpId")]
      public virtual List<SiegeExploitation> SiegeExploitation { get; set; }
   ...
   public partial class DossierIntervention
   {
      ...
      [InverseProperty("DinId")]
      public virtual List<DemandeInterventionAutomatique> DemandeInterventionAutomatique { get; set; }

      [InverseProperty("DinId")]
      public virtual List<DemandeIntervention> DemandeIntervention { get; set; }
   ...
   public partial class LigneTravailleur
   {
      ...
      [InverseProperty("LtrId")]
      public virtual List<LigneOccupation> LigneOccupation { get; set; }

      [InverseProperty("LtrId")]
      public virtual List<CotisationEtudiant> CotisationEtudiant { get; set; }
   ...
   public partial class DrsA037
   {
      ...
      [ForeignKey("DrsId")]
      public virtual DrsEnvoi DrsEnvoi { get; set; }

      [ForeignKey("Y37Id")]
      public virtual DrsA037Dossierannuel DrsA037Dossierannuel { get; set; }

      // Reverse Navigation

      [InverseProperty("A37Id")]
      public virtual List<DrsA037chomagetemporaire> DrsA037chomagetemporaire { get; set; }
   ...
   public partial class Payement
   {
      ...
      [ForeignKey("RcrId")]
      public virtual RetenueCreance RetenueCreance { get; set; }

      [ForeignKey("BnfId")]
      public virtual Beneficiaire Beneficiaire { get; set; }

      [ForeignKey("PppId")]
      public virtual PrimePrepension PrimePrepension { get; set; }
   ...
   public partial class DrsA044Attestation
   {
      ...
      [ForeignKey("D44Id")]
      public virtual DrsA044Dossier DrsA044Dossier { get; set; }
      ...
      [InverseProperty("A44Id")]
      public virtual List<DrsA044Payement> DrsA044Payement { get; set; }
